...
const PartnerLogin = ({ onClose,setShowPartner}) => {
  ...
  const handleLogin = async () => {
    ...
    let result = await fetch(`https://hungry-food-mern-stack.vercel.app/login`,{
        method:'post',
    ...
    <Button>
      <div className='page'>
        <div className='outer'>
          ...
          <div className="sec2">
            New to HungryFood? <div className="link" onClick={direct}>Direct Sign In</div>
          </div>
        </div>
      </div>
    </Button>
